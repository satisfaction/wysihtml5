...
*/
var wysihtml5={version:"0.4.1pre",commands:{},dom:{},quirks:{},toolbar:{},lang:{},selection:{},views:{},INVISIBLE_SPACE:"\ufeff",EMPTY_FUNCTION:function(){},ELEMENT_NODE:1,TEXT_NODE:3,BACKSPACE_KEY:8,ENTER_KEY:13,ESCAPE_KEY:27,SPACE_KEY:32,DELETE_KEY:46};
...
wysihtml5.quirks.cleanPastedHTML=function(){var a={"a u":wysihtml5.dom.replaceWithChildNodes};return function(c,b,d){b=b||a;d=d||c.ownerDocument||document;var e="string"===typeof c,f,g,l,h=0;c=e?wysihtml5.dom.getAsDom(c,d):c;for(l in b)for(f=c.querySelectorAll(l),d=b[l],g=f.length;h<g;h++)d(f[h]);c.innerHTML&&(c.innerHTML=c.innerHTML.replace(/<div><br><\/div>/g,"<br>").replace(/<\/div>/g,"<br>").replace(/<div>/g,""));return e?c.innerHTML:c}}();
